    ...
    <div class="container-fluid">
        ...
        <div class="card rounded">
            <div class="card-header margin-bottom-0">
                <div class="row">
                    <h5 class="card-title">&nbsp;&nbsp;<i class="fa fa-list text-success"></i> Editar departamento</h5>
            ...
            <div class="card-body">
                {!! Form::model($dpto, ['route' => ['dpto.update', $dpto->id],'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal'])!!}
                  @method('PUT')
                  @include('dpto.formedit')
                {!! Form::close() !!}
            </div>
        </div>
