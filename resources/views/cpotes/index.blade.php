                            ...
                            <tbody style="font-size: 12px;">
                               @foreach($cpotes as $cpote)
                                <tr>
                                    ...
                                    {{-- <td>
                                        <a title="Editar" href="{{route('cpotes.edit', $cpote->id)}}" data-toggle="tooltip" data-placement="top" title="Editar" class="btn text-warning rounded elevation-2 btn-group" style="height: 32px; padding-bottom: 3px; border-right:0px; padding-top: 3px;"><i class="fa fa-edit fa-2x"></i></a>
                                    </td> --}}
                                </tr>
                                @endforeach
                            </tbody>
