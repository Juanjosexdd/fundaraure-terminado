    ...
    <div class="container-fluid">
        ...
        <div class="card rounded elevation-2">
            <div class="card-header">
                <div class="row">
                    <h5 class="card-title">&nbsp;&nbsp;<i class="fa fa-edit text-warning"></i> Crear cuentas</h5>
            ...
            <div class="card-body">
                <form action="{{route('cpotes.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        {{csrf_field()}}
                        @include('cpotes.form')
                    </form>
            </div>
