    ...
    <div class="container-fluid">
        ...
        <div class="card rounded elevation-2">
            <div class="card-header">
                <div class="row">
                    <h5 class="card-title">&nbsp;&nbsp;<i class="fa fa-edit text-warning"></i> Editar cuenta pote</h5>
            ...
            <div class="card-body">
                {!! Form::model($megresos, ['route' => ['megresos.update', $megresos->id],'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal'])!!}
                  @method('PUT')
                  @include('megresos.formedit')
                {!! Form::close() !!}
            </div>
        </div>
