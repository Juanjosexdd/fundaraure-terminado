    ...
    <div class="container-fluid">
        ...
        <div class="card rounded elevation-2">
            <div class="card-header">
                <div class="row">
                    <h5 class="card-title">&nbsp;&nbsp;<i class="fa fa-edit text-warning"></i> Registrar egreso</h5>
            ...
            <div class="card-body">
                <form action="{{route('mingresos.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        {{csrf_field()}}
                        @include('megresos.formingreso')
                </form>
            </div>
        </div>
